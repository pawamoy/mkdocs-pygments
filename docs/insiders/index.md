...
*MkDocs Pygments* follows the **sponsorware** release strategy, which means
...
*MkDocs Pygments Insiders* is a private fork of *MkDocs Pygments*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *MkDocs Pygments*.
...
*MkDocs Pygments* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *MkDocs Pygments*,
...
<small>
  ...
  your profile and avatar to show your support for *MkDocs Pygments*.
...
to use *MkDocs Pygments* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *MkDocs Pygments*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *MkDocs Pygments
Insiders* precisely under the same terms as *MkDocs Pygments*, which are given
